...
while True:
    ...
    if (answer == "1"):
        ...
        hub.p_hand, hub.p_deck, hub.p_card_effect_dict, hub.p_values, hub.p_misc_effects = p_char.hand, p_char.deck, p_char.card_effect_dict, p_char.char_values, p_char.misc_effects
        print_space()
        ...
        hub.op_hand, hub.op_deck, hub.op_card_effect_dict, hub.op_values, hub.op_misc_effects = op_char.hand, op_char.deck, op_char.card_effect_dict, op_char.char_values, op_char.misc_effects
        print_space()
        clear()
        target_dict = {"p" : hub.op_values, "op": hub.p_values}
